                ...
                <div className="newmodel">
                    ...
                    >
                        <path
                            ...
                            fill="url(#pointErrorGradient)"
                        />

                        <defs>
                            <linearGradient
                                id="pointErrorGradient"
                                x1="163.5"
                                y1="0"
                                x2="164.033"
                                y2="325"
                    ...
                    >
                        ...
                        >
                            ...
                            <path
                                ...
                                fill="url(#pointErrorCloseGradient)"
                            />

                            <defs>
                                <radialGradient
                                    id="pointErrorCloseGradient"
                                    cx="0"
                                    cy="0"
                                    r="1"
                                    gradientUnits="userSpaceOnUse"
                                ...
                                >
                                    ...
                                    <stop offset="1" stopColor="#6B3EFF" />
                                </radialGradient>
                            </defs>
                    ...
                    <div className="new-success-modal-wrapper-content">
                        ...
                        <p>
                            Your withdrawal points does not meet the withdrawal criteria
                        </p>
