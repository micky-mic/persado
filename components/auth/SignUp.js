...
function Submit() {
    ...
    return (
        <>
            <button type="submit" disabled={pending} className="btn global-white-btn">{pending ? <> Please wait <i className="fa fa-circle-notch rotating-spinner"></i></> : "Create Account"}</button>
        </>
    )
}
        ...
        <>
            ...
            <div className="sign-up-section">
                <div className="signup-heading">
                    <h1 className="playfair-font">Let’s Get Started</h1>
                    <p>Create an account to continue using</p>
                </div>
                <div className="app-global-form signup-form">
                    <form action={handleForm}>
                        ...
                        <div className="app-form-group mt2">
                            ...
                            <div className="create-account">
                                <Link href="/signin"><p className='btn global-white-btnAlt'>Back to Login</p></Link>
                            </div>
                        </div>
                        <div className="form-copyright white-color">
